...
class PprsPersonController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset($_GET['id']) && isset($_GET['pprs_id'])) {
            $model = PprsPerson::model()->find(
                'pprs_id = :pprs_id',
                array(
                    ':pprs_id' => $_GET['pprs_id']
                )
            );
            if ($model !== null) {
                $_GET['id'] = $model->pprs_id;
            } else {
            ...
            try {
                if ($model->save()) {
                    if (isset($_GET['returnUrl'])) {
                        ...
                        $this->redirect(array('view', 'id' => $model->pprs_id));
                    }
                }
            } catch (Exception $e) {
    ...
    public function actionDelete($id)
    {
        if (Yii::app()->request->isPostRequest) {
            ...
            throw new CHttpException(400, Yii::t('D2personModule.model', 'Invalid request. Please do not repeat this request again.'));
        }
    }

    public function actionIndex()
    {
        $dataProvider = new CActiveDataProvider('PprsPerson');
    ...
    {
        $model = PprsPerson::model()->findByPk($id);
        if ($model === null) {
            throw new CHttpException(404, Yii::t('D2personModule.model', 'The requested page does not exist.'));
        }
        return $model;
    }
