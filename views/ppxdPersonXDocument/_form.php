<div class="crud-form">
    ...
    <?php
        ...
        Yii::app()->clientScript->registerScript('crud/variant/update','$("#ppxd-person-xdocument-form select").select2();');
        ...
        <div class="span7">
            ...
            <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_id')) != 'tooltip.ppxd_id')?$t:'' ?>'>
                                <?php
                            ;
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_pprs_id')) != 'tooltip.ppxd_pprs_id')?$t:'' ?>'>
                                <?php
                            $this->widget(
                '\GtcRelation',
                array(
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_pdcm_id')) != 'tooltip.ppxd_pdcm_id')?$t:'' ?>'>
                                <?php
                            $this->widget(
                '\GtcRelation',
                array(
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_number')) != 'tooltip.ppxd_number')?$t:'' ?>'>
                                <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_issue_date')) != 'tooltip.ppxd_issue_date')?$t:'' ?>'>
                                <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_expire_date')) != 'tooltip.ppxd_expire_date')?$t:'' ?>'>
                                <?php
                            $this->widget('zii.widgets.jui.CJuiDatePicker',
                         array(
                                 'model' => $model,
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_notes')) != 'tooltip.ppxd_notes')?$t:'' ?>'>
                                <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('D2personModule.model', 'tooltip.ppxd_status')) != 'tooltip.ppxd_status')?$t:'' ?>'>
                                <?php
                            echo CHtml::activeDropDownList($model, 'ppxd_status', $model->getEnumFieldLabels('ppxd_status'));
